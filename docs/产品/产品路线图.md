...
| id                 | 能力                         | 优先级 | 状态 |
| ------------------ | ---------------------------- | ------ | ---- |
| idea-related-posts | 相关文章（tags 匹配）        | P1     | done |
| idea-md-embeds     | Markdown 嵌入（astro-embed） | P1     | done |
| idea-md-callouts   | 提示框（remark-directive）   | P1     | done |
| idea-ec-code-ux    | EC 行号 / 折叠段             | P1     | done |
