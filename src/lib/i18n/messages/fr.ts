...
export const fr: Catalog = {
  ...
  "tags.tagIntro": "Articles et journaux de build étiquetés « {tag} ».",
  "tags.intro": "Tous les tags, triés par fréquence.",
  "a11y.newWindow": " (s’ouvre dans une nouvelle fenêtre)",
  "archive.yearCount": "{count} entrées",
  "archive.statsDays": "Jours avec des posts",
  "splash.skip": "Passer",
  "splash.brand": "vv",
